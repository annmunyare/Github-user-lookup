...
function task() {
  ...
  return new (_bind.apply(TaskProperty, [null].concat(args)))();
}
...
function taskGroup() {
  ...
  return new (_bind.apply(TaskGroupProperty, [null].concat(args)))();
}
...
function events(obj, eventName) {
  return EventedObservable.create({ obj: obj, eventName: eventName });
}

export { createObservable, all, allSettled, race, subscribe, drop, restartable, enqueue, maxConcurrency, cancelOn, performOn, didCancel };