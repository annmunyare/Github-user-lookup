define('ember-paper/components/paper-icon', ['exports', 'ember', 'ember-paper/templates/components/paper-icon', 'ember-paper/mixins/color-mixin'], function (exports, _ember, _emberPaperTemplatesComponentsPaperIcon, _emberPaperMixinsColorMixin) {
  /**
   * @module ember-paper
   */
  'use strict';
  ...
  var PaperIconComponent = Component.extend(_emberPaperMixinsColorMixin['default'], {
    layout: _emberPaperTemplatesComponentsPaperIcon['default'],
    tagName: 'md-icon',
