define('ember-paper/components/paper-select-menu', ['exports', 'ember', 'ember-paper/components/paper-menu', 'ember-paper/templates/components/paper-select-menu'], function (exports, _ember, _emberPaperComponentsPaperMenu, _emberPaperTemplatesComponentsPaperSelectMenu) {
  /**
   * @module ember-paper
   */
  'use strict';
   ...
   */
  exports['default'] = _emberPaperComponentsPaperMenu['default'].extend({
    layout: _emberPaperTemplatesComponentsPaperSelectMenu['default'],
