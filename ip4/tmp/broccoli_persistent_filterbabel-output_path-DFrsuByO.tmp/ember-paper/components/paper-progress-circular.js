define('ember-paper/components/paper-progress-circular', ['exports', 'ember', 'ember-paper/templates/components/paper-progress-circular', 'ember-paper/mixins/color-mixin'], function (exports, _ember, _emberPaperTemplatesComponentsPaperProgressCircular, _emberPaperMixinsColorMixin) {
  /**
   * @module ember-paper
   */
  'use strict';
  ...
  exports['default'] = Component.extend(_emberPaperMixinsColorMixin['default'], {
    layout: _emberPaperTemplatesComponentsPaperProgressCircular['default'],
